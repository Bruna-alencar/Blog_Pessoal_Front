                ...
                <Grid alignItems="center" item xs={8}>
                    <Box paddingX={20} className="formulario" justifyContent="center">
                        <form onSubmit={onSubmit}>
                            ...
                            <TextField value={userLogin.senha} error={userLogin.senha.length < 8 && userLogin.senha.length > 0} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id="senha" label="Senha" variant="outlined" name="senha" margin="normal" type="password" fullWidth />
